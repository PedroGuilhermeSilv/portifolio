...
export function WorkItem({ href, category, img, title }: WorkItemProps) {
    ...
    return (
        <Link href={href} className="group">
            ...
            >
                ...
                <Image src={img} fill priority quality={100} className="object-cover group-hover:scale-105 transition-all duration-500" alt={title} />
            </div>
